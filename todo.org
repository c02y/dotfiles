...
** non-GUI
   ...
   cargo install cargo-cache cargo-diet cargo-modules cargo-bloat cargo-watch cargo-nextest
...
** GUI
   alacritty kitty mpv vlc meld imagemagick fuse fuse-exfat exfat-utils file-roller darktable krita krita-plugin-gmic copyq nomacs kimageformats fsearch qpdfview
