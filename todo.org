...
** non-GUI
   ...
   # i3 Window Manager
   i3-wm i3lock dunst i3status-rust picom nitrogen dunst pavucontrol blueman gnome-icon-theme
   vimix-cursors polkit-gnome lxappearance-gtk3 qt5ct pcmanfm-gtk3 xfce4-power-manager
   ...
   cargo install cargo-edit cargo-audit cargo-outdated cargo-cache cargo-diet cargo-modules cargo-bloat cargo-watch cargo-nextest cargo-update
