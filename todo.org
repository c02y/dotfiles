...
** non-GUI
   ...
   neomutt npm nodejs lua python-pip proxychains aria2 wget transmission-cli youtube-dl
   ...
   emacs-git w3m ueberzug jq moreutils poppler

   # i3 Window Manager
   i3-wm i3lock dunst i3status-rust picom nitrogen dunst 
   papirus-icon-theme vimix-cursors polkit-gnome lxappearance pcmanfm
...
** GUI
   ...
   noto-fonts noto-fonts-cjk noto-fonts-emoji flameshot peek rofi leafpad thunderbird
...
** for spacemacs
   ...
   npm install -g prettier import-js eslint typescript typescript-language-server tern lua-fmt prettier-plugin-toml vscode-json-languageserver bash-language-server

   luarocks install --local luacheck lanes
** for space-vim
