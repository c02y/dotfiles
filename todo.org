...
** non-GUI
   ...
   htop mediainfo dua-cli lua nodejs ccls global unarchiver aspell-en libmythes mythes-en languagetool
...
* Installed using pip
  # pip install ...
  ipython wheel pynvim rope ropemacs pep8 pylint ptpython pygments ydiff pudb codespell gdb-tools colour-valgrind scan-build compiledb
