...
** non-GUI
   ...
   emacs-git w3m ueberzug jq moreutils poppler paru bear youtube-dl python-pip upx ffmpeg ffmpegthumbnailer meson ninja fzf

   # i3 Window Manager
   manjaro-i3-settings i3status-rust ttf-font-awesome
   ...
   cargo install dua-cli ripgrep bat fd-find mdcat zoxide cargo-cache cargo-diet
...
** GUI
   ...
   noto-sans noto-fonts-cjk noto-fonts-emoji plank flameshot peek rofi leafpad
