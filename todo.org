...
** non-GUI
   ...
   w3m jq moreutils poppler yay pacui emacs-git bear youtube-dl sxiv pip kupfer
...
** GUI
   vlc meld baobab imagemagick fuse fuse-exfat exfat-utils file-roller darktable krita krita-plugin-gmic copyq
