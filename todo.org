...
** non-GUI
   ...
   cargo install cargo-cache cargo-diet cargo-modules cargo-bloat cargo-watch cargo-nextest stylua 
...
** GUI
   ...
   noto-fonts noto-fonts-emoji ttf-droid nerd-fonts-cascadia-code font-manager flameshot peek rofi featherpad thunderbird
