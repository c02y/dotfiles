...
** non-GUI
   ...
   emacs-git w3m ueberzug jq moreutils poppler xdot
   ...
   cargo install cargo-cache cargo-diet cargo-modules
...
** GUI
   ...
   noto-fonts noto-fonts-cjk noto-fonts-emoji nerd-fonts-cascadia-code font-manager flameshot peek rofi leafpad thunderbird
